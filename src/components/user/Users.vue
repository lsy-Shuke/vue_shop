<template>
  <div>
    ...
    <el-dialog
      ...
      <!-- 内容主体区域 -->
      <el-form ref="addFormRef" :model="addForm" label-width="65px" :rules="addFormRules">
...
export default {
  data () {
    ...
    var checkMobile = (rule, value, cb) => {
      // 验证手机号的正则表达式
      const regMobile = /^(0|86|17951)?(13[0-9]|15[012356789]|17[678]|18[0-9]|14[57]|14[57])[0-9]{8}$/
    ...
    return {
      ...
      addFormRules: {
        ...
        password: [
          ...
          { min: 5, max: 10, message: '密码长度在5~10之间', trigger: 'blur' }
        ],
        email: [
